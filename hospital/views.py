...
#for showing signup/login button for admin(by Ravi Raj)
...
#for showing signup/login button for doctor(by Ravi Raj)
...
#for showing signup/login button for patient(by Ravi Raj)
...
#-----------for checking user is doctor , patient or admin(by Ravi Raj)
def is_admin(user):
